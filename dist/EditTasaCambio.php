<?php
    ...
    include '../entidades/vw_tasacambiodet.php';

    
    include '../datos/Dt_tbl_Denominacion.php';
    include '../datos/Dt_tasaCambio.php';
    include '../datos/Dt_tbl_moneda.php';
    include '../datos/Dt_vw_tasaCambiodet.php';

    $datosDeno = new Dt_tbl_Denominacion();
    $datosMone = new Dt_tbl_moneda();
    $datosTasa = new Dt_tasaCambio();
    $datosTasaD = new Dt_vw_tasaCambiodet();

    $varId = $_GET['editT'];
    $vtc = $datosTasa->obtenerTasa($varId);
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Editar un Periodo</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table">
                                    ...
                                    <h2>Editando tasas de cambio</h2>
                                            ...
                                            <div class="col-md-12" >
                                                ...
                                                <input type="hidden" name="idAC" id="idAC" />
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <select class="form-control" name="monedaO" id="monedaO" required>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <select class="form-control" name="monedaC" id="monedaC" required>
                                                            <option value="">Seleccione...</option>
                                                            <?php foreach($datosMone->cbxMoneda() as $r): ?>
                                                            <option value="<?php echo $r->__GET('id_moneda'); ?>" ><?php echo $r->__GET('nombre') ?></option>
                                                            <?php endforeach;?>
                                                    ...
                                                    <div class="card-body"> 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                type="date" placeholder="Ejemplo: dd/MM/yyyy" title="Ingrese una fecha válida!" />
                                                            </div>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    value='0.00' placeholder="0.00" title="Ingrese la tasa de cambio" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table table-bordered table-hover" name="tablaprueba" id="tablaprueba" width="50%" style="text-align: center;" cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <tr><?php foreach($datosTasaD->listarTasaCD($varId) as $r): ?>
                                                                        <tr>
        ...
        <script>
            function setValores()
            {
                ...
                $("#idM").val("<?php echo $varId ?>");
                $("#monedaO").val("<?php echo $vtc->__GET('id_monedaO') ?>");
                $("#monedaC").val("<?php echo $vtc->__GET('id_monedaC') ?>");

                var month = "<?php echo $vtc->__GET('mes') ?>";    
                
                for (let step = 0; step < mes.length; step++) {
                ...
                $("#anio").val("<?php echo $vtc->__GET('anio') ?>");          
            }
        </script>
