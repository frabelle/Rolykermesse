            ...
            <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Registrar una Denominación</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table">
                                    ...
                                    <h2>Registrando una nueva denominación</h2>
                                            ...
                                            <div class="col-md-12" >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            value='0.00' placeholder="0.00" title="Ingrese el valor" min="0.01" required/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row" style="text-align: center;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="btn btn-primary btn-block" type="submit" value="Registrar nueva denominación"/>
                                                        </div>
