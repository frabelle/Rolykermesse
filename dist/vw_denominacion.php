<?php
    error_reporting(0);
    include '../entidades/vw_denominacion.php';
    include '../datos/Dt_vw_denominacion.php';

    $datosDeno = new Dt_vw_denominacion();

        //variable de control msj Nuevo 
        $varMsjNew = 0;
        if(isset($varMsjNew))
        { 
        $varMsjNew = $_GET['msjNewDen'];
        }
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                        ...
                        <img src="../src/assets/img/monedas-banner.jpg" class="card-img-top" alt="moneda">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <h2>Registro de Denominaciones</h2>

                                    <div style="text-align: right;">

                                     <a href="NewDenominacion.php">
                                        <button type="button" class="btn btn-outline-primary btn-sm">
                                            <i class="fas fa-plus"></i> Agregar nueva denominación
                                        </button>
                                     </a><br><br>
                                            ...
                                            <?php foreach($datosDeno->listarDeno() as $r): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" onclick="deleteDen(<?php echo $r->__GET('id_Denominacion'); ?>)"
        ...
        <script>
            ...
            { 
                ...
                var newDen = 0;
                newDen = "<?php echo $varMsjNew ?>";

                if(newDen == "1"){
                    successAlert('Éxito', '¡La denominación ha sido registrada exitosamente!');
                }
                if(newDen == "2"){
                    errorAlert('Error', '¡Ha ocurrido un error al registrar la denominación!');
                }
                if(newDen == "3"){
                ...
                var updDen = 0;
                updDen = "<?php echo $varMsjUpd ?>";

                if(updDen == "1"){
                    successAlert('Éxito', '¡La denominación ha sido editada exitosamente!');
                }
                if(updDen == "2"){
                    errorAlert('Error', '¡Ha ocurrido un error al editar la denominación!');
                }
                if(updDen == "3"){
                ...
                var delDen = 0;
                delDen = "<?php echo $varMsjDel?>";

                if(delDen == "1"){
                    successAlert('Éxito', '¡La denominación ha sido eliminada exitosamente!');
                }
                if(delDen == "2"){
                    errorAlert('Error', '¡Ha ocurrido un error al eliminar la denominación!');
                }
                if(delDen == "3"){
                    errorAlert('Error', '¡Ha ocurrido un error al eliminar la denominación! No se pudo eliminar porque es usada en otros registros.');
                }
        ...
        function deleteDen(a)
        {
            confirm(function(e,btn) { //event + button clicked
                e.preventDefault();
                window.location.href = "../negocio/NgDenominacion.php?delDeno="+a;
            }, 
            function(e,btn) {
                e.preventDefault();
            });
