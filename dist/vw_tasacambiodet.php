<?php
    ...
    $datosTasaCD = new Dt_vw_tasacambiodet();

    $varId = $_GET['view'];

    $vtcd = $datosTasaC->obtenerTasa($varId);
?>
                        ...
                        <img src="../src/assets/img/monedas-banner.jpg" class="card-img-top" alt="moneda">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <h2><?php echo $vtcd->__GET('original') ?>
                                     a <?php echo $vtcd->__GET('cambio') ?>
                                     -   <?php echo $vtcd->__GET('mes') ?>
                                     <?php echo $vtcd->__GET('anio') ?>
                                    </h2>
                                    ...
                                    <table class="table table-bordered table-hover" id="tbl" width="100%" style="text-align: center;" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php foreach($datosTasaCD->listarTasaCD($varId) as $r): ?>
                                                <tr>
                                                    <td><?php echo $r->__GET('tasa');?></td>
