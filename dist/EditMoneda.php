<?php
    ...
    $vm = $datosMoneda->BuscarMoneda($varId);
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Editar una Moneda</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table">
                                    ...
                                    <form method="POST" action="../negocio/NgMoneda.php">
                                        <div class="form-row">
                                            <div class="col-md-12" >
        ...
        <script>
            function setValores()
            {
                ...
                $("#moneda").val("<?php echo $vm->__GET('nombre') ?>");
                $("#simbolo").val("<?php echo $vm->__GET('simbolo') ?>");         
            }
        </script>
