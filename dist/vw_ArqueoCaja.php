<?php
    ...
    include '../datos/Dt_vw_ArqueoCaja.php';

    $datosArqueo = new Dt_vw_ArqueoCaja();
?>
...
<html lang="en">
    <head>
        ...
        <title>Arqueo de Caja - ROLY</title>
                        ...
                        <img src="../src/assets/img/caja-banner.png" class="card-img-top" alt="moneda">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <h2>Registros de Arqueo en Caja</h2>

                                    <div style="text-align: right;">

                                     <a href="NewArqueoCaja.php">
                                        <button type="button" class="btn btn-outline-primary btn-sm">
                                            <i class="fas fa-plus"></i> Agregar nuevo arqueo de caja
                                        </button>
                                     </a><br><br>
                                    ...
                                    <table class="table table-bordered table-hover" id="tbl" width="100%" style="text-align: center;" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php foreach($datosArqueo->listarArqueo() as $r): ?>
                                                <tr>
                                                    <td><?php echo $r->__GET('id_ArqueoCaja');?></td>
                                                    <td><?php echo $r->__GET('nombre');?></td>
                                                    <td>C$ <?php echo $r->__GET('granTotal');?></td>
                                                    <td><?php echo $r->__GET('fechaArqueo');?></td>
                                                    
                                                    <td>

                                                        <a href="vw_arqueocajadet.php?view=<?php echo $r->__GET('id_ArqueoCaja'); ?>"  
                                                        title="Visualizar datos de Arqueo de Caja">
                                                        ...
                                                        <a href="EditArqueoCaja.php?editA=<?php echo $r->__GET('id_ArqueoCaja'); ?>" 
                                                        title="Modificar los datos de Arqueo de Caja">
