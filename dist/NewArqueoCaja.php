                                            ...
                                            <div class="col-md-12" >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        type="date" placeholder="Ejemplo: dd/MM/yyyy" disabled/>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input class="form-control" name="valor" id="valor" type="number" step='1.00' 
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row" style="text-align: center;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="btn btn-primary btn-block" type="submit" value="Registrar nuevo arqueo"/>
                                                        </div>
